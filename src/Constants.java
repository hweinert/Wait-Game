public abstract class Constants {
	public static String saveFile = "Wait Game.data";
	
	public static int levelUpExpNeeded = 250;
	
	public static int expGain = 10;
	public static int goldGain = 10;
	
	public static int intelligencePrice = 100;
